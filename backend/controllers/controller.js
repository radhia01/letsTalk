...
const register = async (req, res) => {
  try {
    ...
    const data = new users({
      ...
      actif: false,
      img: "https://res.cloudinary.com/db8b6npfz/image/upload/v1710331790/360_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8_imo96g.jpg",
      phone,
      invitations: [],
      friendsList: [],
      messages: [],
...
const editpassword = async (req, res) => {
  try {
    ...
    if(!passwordHush){
      return res.status(400).json({error:"last password is incorrect"})
    }
